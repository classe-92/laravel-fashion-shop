<!-- Topbar -->
<nav class="navbar navbar-expand justify-content-between navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <!-- Nav Item - Messages -->
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" id="messagesDropdown" role="button" data-bs-toggle="dropdown"
        ...
        <li class="nav-item dropdown no-arrow">
            <a id="navbarDropdown" class="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown"
                ...
                {{ Auth::user()->name }}
                <img class="img-profile rounded-circle" src="/images/undraw_profile_3.svg">
            </a>
